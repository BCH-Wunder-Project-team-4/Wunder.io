...
export function FollowUs() {
    ...
    return (
        <div className="py-10">
            <div>
                <h1 className="text-center text-primary-500 font-bold text-2xl " data-aos="fade">{t("Follow Us")}</h1>
            </div>
            <div>
                <p className="text-center text-sm pb-2 font-semibold" data-aos="fade">{t("Connect with various social media platforms")}</p>
            </div>
